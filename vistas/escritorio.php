                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="small-box bg-purple">
                                <a href="asistenciamanual.php" class="small-box-footer">
                                    <div class="inner">
                                        <h5 class="font-size: 20px;">
                    ...
                    <div class="panel-body">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="small-box bg-black">
                                <a href="gencertificado.php" class="small-box-footer">
                                    <div class="inner">
                                        <h5 class="font-size: 20px;">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="small-box bg-gray">
                                <a href="configuracion.php" class="small-box-footer">
                                    <div class="inner">
                                        <h5 class="font-size: 20px;">
                                            <strong>Configuracion del QR</strong>
                                        </h5>
                                        <p>Modulo</p>
                                    </div>
                                    <div class="icon">
